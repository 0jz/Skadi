...
object CsvPasswordImporter {
     ...
     * Returns the original URL if no entry is found.
     */
    fun securityUrlFor(siteUrl: String): String {
        val host = extractDomain(siteUrl)
        // Full host match (e.g. "mail.google.com")
        SECURITY_URLS[host]?.let { return it }
        // Registered-domain match (e.g. "google.com" from "mail.google.com")
